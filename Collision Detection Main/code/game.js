...
/*function functionName(){
	this.pos = new Vector(1,17)
} Trying to add color change and restart on death */ 
...
Player.prototype.moveY = function(step, level, keys) {
  ...
  if(obstacle == 'lava'){
	...
	//if it IS lava then allow it to proceed but still have it "kill" you. 
  }
};
